...
# templates/basic-project/outputs.tf
# Outputs for the basic Tero project
...
**Description**: Exports key outputs from the `tero` module for verification and integration.
