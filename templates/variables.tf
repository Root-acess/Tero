...
# Variables for the default Tero template
...
# Optional multi-cloud variables
...
**Description**: Defines variables for the default template, mirroring `basic-project`.

**Use Cases**:
- Customizing the default configuration.
- Supporting quick setup with defaults.
- Enabling multi-cloud extensibility. */